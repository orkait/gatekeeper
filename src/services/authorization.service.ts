import type { AuthRepository, TenantRole } from '../repositories/auth.repository';
import type { ServiceResult } from '../types';
import type { AuthCache } from '../utils/cache';
import { buildCacheKey, CacheKeyPrefix, AUTH_CACHE_TTL_SECONDS } from '../utils/cache';
import { QuotaService, type QuotaCheckResult } from './quota.service';
import { SubscriptionService, type SubscriptionTier } from './subscription.service';
import { FeatureFlagService } from './featureflag.service';
import { OverrideService, type ParsedOverrides } from './override.service';
...
/**
 * Metadata about the authorization decision.
 */
...
/**
 * Record of which authorization checks passed.
 */
